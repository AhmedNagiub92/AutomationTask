package magentoWeb.utilities.extent_report;
...
public class ExtentReport {
    ...
    private static final String extentReportConfigPath = System.getProperty("user.dir") + "/src/test/java/magentoWeb/utilities/extent_report/";
